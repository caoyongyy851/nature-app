...
function getCanvasImage(that, canvasId, imagePath, imageW, imageH, getImgsuccess) {
 ...
 */
function getLessLimitSizeImage(that,canvasId, imagePath, limitSize = 100, drawWidth, callBack) {
        ...
        (moreRes) => {
            wx.getImageInfo({
                ...
                success: function(imageInfo) {
                    ...
                    getCanvasImage(that,canvasId, imagePath, imageW, imageH,
                        (pressImgPath) => {
                            getLessLimitSizeImage(that,canvasId, pressImgPath, limitSize, drawWidth * 0.95, callBack);
                        }
                    );
                }
            })
