...
var _playDetail = _interopRequireDefault(__webpack_require__(/*! ./pages/play-detail/play-detail.vue */ 166));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;
...
/* harmony import */ var _play_detail_vue_vue_type_template_id_0506f69c___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./play-detail.vue?vue&type=template&id=0506f69c& */ 167);
/* harmony import */ var _play_detail_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./play-detail.vue?vue&type=script&lang=js& */ 169);
...
/* harmony import */ var _play_detail_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./play-detail.vue?vue&type=style&index=0&lang=css& */ 171);
        ...
        if (!this.queryHotParams.isBottom) {
          ...
          then(function (res) {
            if (res.data.length != 0) {
              ...
              _this2.hotCardList = [].concat(_toConsumableArray(_this2.hotCardList), _toConsumableArray(newHotCardList));
            } else {
        ...
        if (!this.queryNewParams.isBottom) {
          ...
          then(function (res) {
            if (res.data.length != 0) {
              ...
              _this2.newCardList = [].concat(_toConsumableArray(_this2.newCardList), _toConsumableArray(newNewCardList));
            } else {
