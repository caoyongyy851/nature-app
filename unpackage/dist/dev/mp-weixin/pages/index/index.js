...
var loadMore = function loadMore() {
  __webpack_require__.e(/*! require.ensure | components/common/load-more */ "components/common/load-more").then((function () {
    return resolve(__webpack_require__(/*! @/components/common/load-more.vue */ 370));
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                _context.next = 9;
                return _this2.$u.api.getCardList({
                  pageNum: 1,
                  pageSize: 6
                }).then(function (res) {
                  obj = {
              ...
              case 11:
                ...
                _context.next = 14;
                return _this2.$u.api.getCardGuanzhuList({
                  pageNum: 1,
                  pageSize: 6
                }).then(function (res) {
                  obj = {
      ...
      if (index === 0) {
        ...
        this.$u.api.getCardList(this.queryParams).then(function (res) {
          if (res.data.length != 0) {
            item.list = [].concat((0, _toConsumableArray2.default)(item.list), (0, _toConsumableArray2.default)(res.data));
