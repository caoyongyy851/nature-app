...
var _detail = _interopRequireDefault(__webpack_require__(/*! ./pages/detail/detail.vue */ 104));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;
...

{
  ...
  (0, _vuex.mapActions)(['login', 'authUserInfo'])), {}, {
    ...
    toTopic: function toTopic() {
      uni.navigateTo({
        url: "../play-detail/play-detail?id=".concat(this.cardDetail.topicId) });
