...
var _detail = _interopRequireDefault(__webpack_require__(/*! ./pages/detail/detail.vue */ 125));
// @ts-ignore
      ...
      if (this.isLike) {
        ...
        this.$u.api.cardToLike({
          ...
          if (res.code === 200) {
            ...
            _this5.cardDetail.avatarLikes.splice(_this5.cardDetail.avatarLikes.findIndex(function (item) {
              return item === _this5.getUserinfo.avatar;
            }), 1);
          }
        });
      } else {
