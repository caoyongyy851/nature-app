...
var _placeDetail = _interopRequireDefault(__webpack_require__(/*! ./pages/place-detail/place-detail.vue */ 90));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;
...
/* harmony import */ var _place_detail_vue_vue_type_template_id_dbd78534___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./place-detail.vue?vue&type=template&id=dbd78534& */ 91);
/* harmony import */ var _place_detail_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./place-detail.vue?vue&type=script&lang=js& */ 93);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _place_detail_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _place_detail_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var _place_detail_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./place-detail.vue?vue&type=style&index=0&lang=css& */ 95);
...

{
  ...
  (0, _vuex.mapActions)(['login', 'setPhone', 'authUserInfo'])), {}, {
    ...
    // 收藏
    toCollect: function toCollect() {var _this3 = this;
      if (this.isCollect) {
        // 取消收藏
    ...
    toLike: function toLike() {var _this4 = this;
      if (this.isLike) {
        // 取消喜欢
        ...
        then(function (res) {
          if (res.code === 200) {
            ...
            _this4.cardDetail.avatarLikes.splice(_this4.cardDetail.avatarLikes.findIndex(function (item) {return (
                item === _this4.getUserinfo.avatar);}), 1);
          }
        });
      } else {
        // 喜欢
    ...
    // 创建订单
    toCreateOrder: function toCreateOrder() {var _this6 = this;
      if (this.getNeedAuth) {
        this.authUserInfo();
        return;
      }
