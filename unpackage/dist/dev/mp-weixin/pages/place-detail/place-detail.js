...

{
  ...
  (0, _vuex.mapActions)(['login', 'setPhone', 'authUserInfo'])), {}, {
    ...
    writePlaceConsult: function writePlaceConsult() {var _this7 = this;
      if (this.getNeedAuth) {
        this.authModal.show = true;
        return;
      }
    ...
    toAuth: function toAuth() {var _this8 = this;
      if (this.getNeedAuth) {
