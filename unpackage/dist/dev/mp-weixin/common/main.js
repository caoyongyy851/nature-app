...
var divider = function divider() {__webpack_require__.e(/*! require.ensure | components/common/divider */ "components/common/divider").then((function () {return resolve(__webpack_require__(/*! ./components/common/divider.vue */ 255));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component("divider", divider);var noThing = function noThing() {__webpack_require__.e(/*! require.ensure | components/common/no-thing */ "components/common/no-thing").then((function () {return resolve(__webpack_require__(/*! ./components/common/no-thing.vue */ 260));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component("no-thing", noThing);_App.default.mpType = 'app';var app = new _vue.default(_objectSpread(_objectSpread({}, _App.default), {}, { store: _store.default })); // http拦截器，此为需要加入的内容，如果不是写在common目录，请自行修改引入路径
